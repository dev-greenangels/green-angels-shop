...
const faqCategories = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 'Ми приймаємо оплату готівкою при отриманні (накладний платіж), оплату на карту ПриватБанку, а також безготівковий розрахунок для юридичних осіб.',
      },
      {
    ...
    questions: [
      {
        ...
        answer: 'Ми доставляємо по всій Україні через Нову Пошту та Укрпошту. Також можлива самовивіз з нашого розсадника у Вишгороді.',
      },
      {
        question: 'Скільки коштує доставка?',
        answer: 'Вартість доставки залежить від ваги та габаритів замовлення і розраховується за тарифами перевізника. Для замовлень від 3000 грн - безкоштовна доставка по Україні.',
      },
      {
