...
/** Відступ sticky-панелей каталогу під хедером (`--site-header-offset` + невеликий зазор). */
export const catalogSidebarStickyTopClassName =
  'top-[calc(var(--site-header-offset,5rem)+0.5rem)]'
/** Fallback px для JS-розрахунків висоти, поки CSS var ще не зчитано. */
export const catalogSidebarStickyTopPx = 88
